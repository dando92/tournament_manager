    ...
    <div className="flex flex-col sm:flex-row gap-2">
      <div className="relative sm:w-48 shrink-0">
        <select
          ...
          className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm bg-white appearance-none pr-8 focus:outline-none focus:ring-2 focus:ring-brand-600"
        >
      ...
      <div className="relative flex-1">
        ...
        <input
          ...
          className="w-full border border-gray-300 rounded-lg pl-9 pr-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-brand-600"
        />
      </div>
    </div>
  );
