...
export class InitialSchema1787085404083 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "tournament" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "syncstartUrl" character varying NOT NULL DEFAULT 'ws://syncservice.groovestats.com:1337', "startggApiKey" character varying, "availableSetupsCount" integer NOT NULL DEFAULT '2', "defaultScoringSystem" character varying NOT NULL DEFAULT 'EurocupScoreCalculator', CONSTRAINT "PK_449f912ba2b62be003f0c22e767" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
